...
export default function PricinHero() {
  ...
  return (
    <section className="flex items-center mx-0 md:mx-36 border-x py-6 md:py-10 border-1 border-[#ffffff14] px-4 sm:px-6 lg:px-8 relative">
      ...
      >
        ...
        >
          From individual developers to enterprise teams, explore our flexible
          pricing plans designed to strengthen your security infrastructure at
          any scale.
        </motion.p>
