    ...
    <section className="flex items-center mx-0 md:mx-36 border-x py-6 md:py-10 border-1 border-[#ffffff14] px-4 sm:px-6 lg:px-8 relative">
      ...
      >
        ...
        >
          ...
          Stay informed about the latest trends and best practices in technology.
        </motion.p>
        ...
        >
          ...
          <Button className="rounded-full bg-gradient-to-r from-[#DB5F39] to-[#E98260] hover:opacity-90">
